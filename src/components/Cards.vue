      ...
      >
        ...
        >
          <div class="row align-items-center">
            ...
            >
              <i class="far fa-heart fa-lg" style="user-select: auto"></i>
            </div>
            <div
              class="col col-md-auto"
...
export default {
  ...
  data() {
    return {
      ...
      personDetail: null,
      isCard: true,
      favoriteArr: this.favoriteData,
      filterData: this.filterLists,
    };
  },
  created() {
    setTimeout(() => {
  ...
  methods: {
    ...
    openDetail(id) {
      this.personDetail = this.filterData.find((item) => {
    ...
    addFavorite(id) {
      this.filterData.forEach((item) => {
        if (item.login.md5 === id && item.isFavorite === false) {
